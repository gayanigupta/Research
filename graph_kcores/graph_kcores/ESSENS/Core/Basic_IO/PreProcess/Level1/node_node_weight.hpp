...
void node_node_wt(char* file, char* gfile, char* mapfile)
{
    ...
    // Activity 1: Translate Strings to Numbers 
    string st1, st2, wt;
    map_st_int nodemap;
    ...
    for (const auto& edge : myEdges) {
        cout << "Node1: " << edge.node1 << ", Node2: " << edge.node2 << ", Weight: " << edge.edge_wt << endl;
    }
    cout << endl;


    // Activity 2: Store Map for Back Translation
    ofstream myfile1;
